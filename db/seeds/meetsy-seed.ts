...
import {
    communitiesTable as communities,
    communityMembersTable as communityMembers,
    conversationsTable as conversations,
    conversationSummariesTable as conversationSummaries,
    learningGoalsTable as learningGoals,
	...
	try {
		...
		for (const community of communitiesData) {
			const [created] = await db
				...
				.values({
					...community,
					ownerId: createdProUsers[0].id, // Emma creates all communities
				})
				.returning();
